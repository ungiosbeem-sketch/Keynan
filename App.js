...
function SchoolProvider({ children }) {
  ...
  return (
    <SchoolContext.Provider value={{ schedule, homework, addHomework, toggleHomework, deleteHomework }}>
      {children}
...
function ReadingProvider({ children }) {
  ...
  return (
    <ReadingContext.Provider value={{ readingList, currentBook, addBook, updateProgress, deleteBook }}>
      {children}
