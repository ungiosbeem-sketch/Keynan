...
// ============ CALENDAR SCREEN (Version fudud oo shaqeynaya) ============
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView style={styles.calendarTasksList}>
        <Text style={styles.sectionTitle}>Tasks for {formatDate(selectedDate)}</Text>
...
const styles = StyleSheet.create({
  ...
  datePickerBtn: { flexDirection: 'row', alignItems: 'center', backgroundColor: COLORS.card, padding: 15, borderRadius: 12, gap: 10, marginTop: 10 },
  datePickerText: { color: COLORS.white, fontSize: 16 },
